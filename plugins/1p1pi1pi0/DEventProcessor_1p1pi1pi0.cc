...
jerror_t DEventProcessor_1p1pi1pi0::evnt(JEventLoop *loop, uint64_t eventnumber)
{
  ...
  double dEdx_TOF_protcand     = (hyp_pr->Get_TOFHitMatchParams() != NULL) ? hyp_pr->Get_TOFHitMatchParams()->dEdx : 999.0;
  double dEdx_ST_protcand      = (hyp_pr->Get_SCHitMatchParams() != NULL) ? hyp_pr->Get_SCHitMatchParams()->dEdx : 999.0;
  double dEdx_CDC_protcand      = (hyp_pr->Get_TrackTimeBased() != NULL) ? hyp_pr->Get_TrackTimeBased()->ddEdx_CDC : 999.0;
  double dEdx_FDC_protcand      = (hyp_pr->Get_TrackTimeBased() != NULL) ? hyp_pr->Get_TrackTimeBased()->ddEdx_FDC : 999.0;
  ...
  double Energy_BCAL_protcand  = (showerprot != NULL ) ? showerprot->E : 999.0;
  double Energy_BCALPreshower_protcand  = (showerprot != NULL ) ? showerprot->E_preshower : 999.0;
  double SigLong_BCAL_protcand = (showerprot != NULL ) ? showerprot->sigLong : 999.0;
  double SigTheta_BCAL_protcand= (showerprot != NULL ) ? showerprot->sigTheta : 999.0;
  double SigTrans_BCAL_protcand= (showerprot != NULL ) ? showerprot->sigTrans : 999.0;
  double RMSTime_BCAL_protcand = (showerprot != NULL ) ? showerprot->rmsTime : 999.0;
  double E_BCAL_protcand = (showerprot != NULL ) ? showerprot->E : 999.0;
  double x_BCAL_protcand = (showerprot != NULL ) ? showerprot->x : 999.0;
  double y_BCAL_protcand = (showerprot != NULL ) ? showerprot->y : 999.0;
  double z_BCAL_protcand = (showerprot != NULL ) ? showerprot->z : 999.0;
  double t_BCAL_protcand = (showerprot != NULL ) ? showerprot->t : 999.0;
  ...
  double Energy_FCAL_protcand = (FCALshowerprot != NULL) ? FCALshowerprot->getEnergy() : 999.0;
  double E1E9_FCAL_protcand   = (FCALshowerprot != NULL) ? FCALshowerprot->getE1E9() : 999.0;
  double E9E25_FCAL_protcand  = (FCALshowerprot != NULL) ? FCALshowerprot->getE9E25() : 999.0;
  double SumU_FCAL_protcand   = (FCALshowerprot != NULL) ? FCALshowerprot->getSumU() : 999.0;
  double SumV_FCAL_protcand   = (FCALshowerprot != NULL) ? FCALshowerprot->getSumV() : 999.0;
