...
#ifndef _DEventProcessor_1p1pi_
#define _DEventProcessor_1p1pi_
...
class DEventProcessor_1p1pi:public JEventProcessor{
 public:
  DEventProcessor_1p1pi(){};
  ~DEventProcessor_1p1pi(){};
  const char* className(void){return "DEventProcessor_1p1pi";}
